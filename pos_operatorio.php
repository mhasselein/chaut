                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="portfolio-single-img">
                                <img class="img-responsive" alt="Fotodepilação" src="images/portfolio/pos1.gif">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="portfolio-content" style="padding: 0px;">
                                ...
                                <p align="justify">
                                    ...
                                    com movimentos de compressão e descompressão, a partir de movimentos leves e lentos, que direcionam
                                    e melhoram o fluxo linfático, além de ativar a oxigenação celular e a nutrição dos tecidos.  
                                    Realizada de forma lenta, suave e rítmica, promove relaxamento do paciente e do corpo 
                                    (pois a dor não faz parte desta conduta), redução de edemas,  hematomas, fibrose,  melhora a cicatrização
                                    e redução da dor.
                                </p>
                                <p align="justify">
