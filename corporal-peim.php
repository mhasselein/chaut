...
<html class="no-js">
    <head>
        ...
        <title>PEIM - Clínica de Estética - Clínica Haut </title>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="portfolio-single-img">
                            <img class="img-responsive" alt="" src="images/portfolio/corporal/peim.jpg">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="portfolio-content" style="padding: 0px;">
                            <h3>PEIM</h3>
                            <p align="justify">
                                O <strong>Procedimento estético injetável para microvasos (PEIM)</strong> é um tratamento realizado com o objetivo de eliminar os 
                                <strong>vasinhos</strong> que aparecem nas pernas e se tornam um incomodo <strong>estético</strong> para as mulheres. 
                               É um procedimento simples, mas que exige cautela para identificar os vasos a serem tratados.
                            </p>
                            <p align="justify">
                                Através de uma agulha muito fina, é injetado no vaso um medicamento <strong>líquido esclerosante</strong>, que vai 
                                causar uma alteração nas suas células, levando ao fechamento deste vaso, com isso o aspecto estético 
                                das pernas é melhorado.
                            </p>
                            <p align="justify">
                                O surgimento dos <strong>vasinhos(chamados detelangiectasias)</strong> pode estar associado a um refluxo de sangue que ocorre em 
                                veias mais profundas, isso pode ser causado por algum problema nas válvulas que tem a função de direcionar o 
                                sangue no sentido correto. Mas existem também outros fatores que influenciam este aparecimento, entre eles estão: 
                                genética, gestações, posição (ficar em pé ou sentado durante muito tempo), uso de anticoncepcionais, que em conjunto 
                                ou isoladamente, dificultam a circulação sanguínea nas pernas, levando a formação dos indesejáveis vasinhos.
                            </p>
                            <p align="justify">
                                O número de sessões varia de acordo com cada paciente, enquanto em alguns casos pode ser necessária apenas uma aplicação, 
                                existem casos em que pode ser preciso fazer outras sessões até obter o resultado pretendido. 
                                Quanto mais grosso e visível vaso a ser tratado, maior será o número de sessões necessárias
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="works works-fit">
            <div class="container">
                ...
                <p class="subtitle-des">
                    Os cliente da <strong>Clínica Haut</strong> que procuraram por <strong>PEIM</strong>,
                    <br> também procuraram pelos <strong>tratamentos estéticos</strong> citados abaixo.
                </p>
                <div class="row">
                    <div class="row">
