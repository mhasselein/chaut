                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="portfolio-content" style="padding: 0px;">
                                ...
                                <p>
                                    O tratamento é realizado através de dispositivos compostos por pequenas agulhas que causam microperfurações na pele. Estas microperfurações são responsáveis pela indução de um processo inflamatório no local, capaz de estimular os fibroblastos (células responsáveis pela produção de colágeno local), oferecendo a oportunidade de melhorar a aparência envelhecida, por meio da redução de rugas, combate à flacidez facial, melhora da textura e aumento da luminosidade.
                                </p>
                                <p>
                                    O microagulhamento pode ser usado para diversos problemas de pele, como envelhecimento, flacidez, cicatrizes de acne ou queimaduras, estrias e manchas na pele (como o melasma, por exemplo).
                                </p>
                                <p>
                                    Ele pode ser feito em qualquer lugar do corpo, como rosto, colo, pescoço, mãos, braços, seios, coxas, abdômen, entre outros. Inclusive pode ser feito no couro cabeludo, para estimular a circulação sanguínea da região e favorecer o tratamento contra queda de cabelo.
                                </p>
                            </div>
