...
<html class="no-js">
    <head>
        ...
        <title>Corrente Russa - Clínica de Estética - Clínica Haut </title>
                    ...
                    <div class="col-md-12">
                        <div class="block">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active">Corrente Russa</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="portfolio-single-img">
                            <img class="img-responsive" alt="" src="images/portfolio/corporal/estetica-corporal-corrente_russa.gif">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="portfolio-content" style="padding: 0px;">
                            <h3>Corrente Russa</h3>
                            <p align="justify">
                                A corrente russa é um estímulo elétrico usado para produzir uma contração muscular no local em que ela é aplicada.  
                            </p>
                            <p align="justify">
                               A técnica foi desenvolvida na Rússia (como o nome já evidência), na década de 80, e foi utilizada inicialmente para 
                               a <strong>melhora da flacidez</strong>, atrofia e fadiga muscular que os astronautas do país apresentavam, pela falta da ação da 
                               gravidade na musculatura, ao retornar de suas missões espaciais.
                            </p>
                            <p align="justify">
                               Enquanto muitos tratamentos estéticos agem na pele e na gordura, a corrente russa dispara estímulos que fazem os
                               músculos contraírem.
                            </p>
                            <p align="justify">
                                O método é usado para promover maior <strong>tonicidade muscular</strong> corporal, melhora da flacidez e contorno corporal, 
                                sendo assim uma ótima opção para homens e mulheres que desejam conseguir esses benefícios.
                                Ele ainda é indicado para a recuperação do tônus muscular pós-parto e pós-emagrecimento.
                            </p>
                        </div>
                    </div>
                </div>
