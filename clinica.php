      ...
      <?php include_once 'header.php';?>
        ...
        <section class="about-feature clearfix">
            <div class="container-fluid">
                <div class="row">
                    <div style="height: 250px" class="block about-feature-1 wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".3s">
                        <h2>
                        Nossa Missão
                        </h2>
                        <p>
                            Proporcionar bem-estar e realização através das melhores e mais completas soluções em estética e beleza.
                        </p>
                    </div>
                    <div style="height: 250px" class="block about-feature-2 wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".5s">
                        ...
                        <p>
                            Sermos referência em tratamentos estéticos aliados à promoção da saúde e Qualidade de Vida.
                        </p>
                    </div>
                    <div style="height: 250px" class="block about-feature-3 wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".7s">
                        <h2 class="item_title">
                        Nossos Valores
                        </h2>
                        <p>
                            Comprometimento com a qualidade dos tratamentos.Responsabilidade nos processos executados.Transparência no relacionamento com clientes.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section id="team">
            <div class="container">
                <div class="row">
                    <h2 class="subtitle text-center">Conheça Nossos Profissionais</h2>
                    <div class="col-md-4">
                        <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".3s">
                            ...
                            <p class="social-icons">
                                <a href="http://www.facebook.com/leticia" class="facebook" target="_blank"><i class="ion-social-facebook-outline"></i></a>
                    ...
                    <div class="col-md-4">
                        <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".7s">
                            ...
                            <h3 class="team_name">Nutricionista</h3>
                            <p class="team_designation">CEO, Project Manager</p>
                            <p class="team_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore .</p>
                            <p class="social-icons">
                                <a href="#" class="facebook" target="_blank"><i class="ion-social-facebook-outline"></i></a>
