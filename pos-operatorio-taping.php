        ...
        <section class="works works-fit">
            <div class="container">
                ...
                <p class="subtitle-des">
                    Os cliente da <strong>Clínica Haut</strong> que procuraram por <strong>Taping</strong>,<br> também procuraram pelos <strong>tratamentos estéticos</strong> citados abaixo.
                </p>
                <div class="row">
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-12">
                            <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="300ms">
                                <div class="img-wrapper">
                                    <img src="images/portfolio/pos/ultrasson-pos-operatorio.gif" class="img-responsive" alt="Pós-operatório Ultrasson" >
                                    <div class="overlay">
                                        <div class="buttons" style="left: 30%">
                                            <a href="pos-operatorio-ultrasson">Mais Detalhes</a>
                                        </div>
                                    </div>
                                </div>
                                <figcaption>
